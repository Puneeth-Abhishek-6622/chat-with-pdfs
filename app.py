...
def get_conversational_chain():
    prompt_template = """ 
    Provide a detailed and accurate answer based solely on the context provided below. 
    If the answer cannot be found within the given context, respond with: "The answer is not available in the context." 
    Do not attempt to fabricate or guess any information.
